...
- [Mobile public-API gotchas](mobile-public-api-gotchas.md) — unauth clients: wildcard CORS forbids credentials; server ignores sortBy & serves NSFW; /api/prompts/:id skips isPublic. Filter/sort client-side.
